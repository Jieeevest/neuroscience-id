...
const Hero = () => {
  ...
  // State for storing images from Unsplash
  ...
  useEffect(() => {
    const fetchImages = async () => {
      setIsLoading(true);
      try {
        // Array of neuroscience-related search terms
        const searchTerms = [
          "brain",
          "neuroscience",
          "neural network",
        ...
        // Create an array of image URLs from Unsplash
        const imageUrls = searchTerms.map(term => 
          `https://source.unsplash.com/1600x900/?${term}`
        );
        ...
        setImages(["https://source.unsplash.com/1600x900/?brain"]);
      } finally {
        setIsLoading(false);
      }
    };
        ...
        {!isLoading && images.length > 0 && (
          ...
          >
            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-900/80 via-primary/60 to-blue-900/80"></div>
            </div>
          </motion.div>
        )}
